...
///
/// ikfast version 0x1000004b generated on 2026-06-16 18:17:56.268811
...
IkReal x28=((1.0)*x25);
IkReal x29=((1.0)*x12);
eetrans[0]=((0.01)+((x6*(((((-1.0)*x20*x28))+((x20*x21))))))+((x6*(((((-1.0)*x23*x29))+(((-1.0)*x22*x29))))))+((x5*((((x20*x22))+((x20*x23))))))+((x0*x16))+(((-1.0)*x0*x27))+(((0.23681015)*x26))+(((5.3e-7)*x0*x21))+((x5*((((x12*x21))+(((-1.0)*x12*x28))))))+((x15*x23))+((x15*x22)));
IkReal x30=((1.0)*x25);
IkReal x31=((1.0)*x18);
...
eetrans[2]=((0.12356)+(((0.14459)*x21))+((x5*(((((-0.16908)*x25))+(((0.16908)*x21))))))+((x5*(((((-0.01515)*x23))+(((-0.01515)*x22))))))+((x6*(((((0.01515)*x25))+(((-0.01515)*x21))))))+(((-5.3e-7)*x23))+(((-5.3e-7)*x22))+(((0.23681015)*x1))+((x6*(((((-0.16908)*x23))+(((-0.16908)*x22))))))+(((-0.02999885)*x4))+(((-0.14459)*x25)));
IkReal x32=((1.0)*x13);
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - roarm_m3 (0fafcb85140161b7e0ce8b23035b0537)>"; }
